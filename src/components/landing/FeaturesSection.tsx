          ...
          {features.map((feature, index) => (
            ...
            >
              <CardHeader className="pb-3 md:pb-6">
                <div className={`inline-flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-lg bg-primary/10 mb-3 md:mb-4 group-hover:bg-primary/20 transition-colors ${feature.color}`}>
